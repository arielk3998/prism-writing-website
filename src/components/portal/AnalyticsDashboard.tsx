      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
              <h5 className="font-medium text-green-800 dark:text-green-200">Total Revenue</h5>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
              <h5 className="font-medium text-blue-800 dark:text-blue-200">Active Projects</h5>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            <h5 className="font-medium text-gray-900 dark:text-white mb-2">Team Utilization</h5>
          ...
          <div className="text-center">
            <h5 className="font-medium text-gray-900 dark:text-white mb-2">Client Satisfaction</h5>
            <div className="flex items-center justify-center space-x-1 mb-2">
              {[...Array(5)].map((_, i) => (
                <span 
                  key={i} 
                  className={`text-2xl ${i < Math.floor(analyticsData.team.satisfaction) ? 'text-yellow-400' : 'text-gray-300'}`}
                >
                  ⭐
                </span>
              ))}
          ...
          <div className="text-center">
            <h5 className="font-medium text-gray-900 dark:text-white mb-2">Productivity Score</h5>
            <div className="relative w-32 h-32 mx-auto">
              <svg className="transform -rotate-90 w-32 h-32">
                <circle
                  cx="64"
